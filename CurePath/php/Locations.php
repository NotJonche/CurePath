...
<body>
    <div class="pc">
        ...
        <div class="aabout container-row bg-gray center">
            <h1 class="about-text animate__animated animate__fadeInDown color-g">Our Locations</h1>
        </div>
        <div class="locations-content container-max container-column">
            <div class="l-top">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2934.376467517507!2d21.146825!3d42.653377!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13549f3f9c98dcad%3A0x34f016cddf4a9928!2sDukagjini%20Center!5e0!3m2!1sen!2sus!4v1733760305573!5m2!1sen!2sus"
                    style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                </iframe>
            </div>
            <div class="l-bottom">
                <ul>
                    <h1 class="center color-bl" style="margin-bottom: 35px;">Our Locations:</h1>
                    <li>
                        <a href="https://tinyurl.com/bddy24nx" target="_blank" class="color-b">
                            <i class="fa-solid fa-location-pin"></i>CurePath
                        </a>
                    </li>
                    <li>
                        <a href="https://tinyurl.com/437dfve8" target="_blank" class="color-b">
                            <i class="fa-solid fa-location-pin"></i>CurePath - Dukagjini Center
                        </a>
                    </li>
                    <li>
                        <a href="https://tinyurl.com/5t486wnp" target="_blank" class="color-b">
                            <i class="fa-solid fa-location-pin"></i>CurePath - Innovation Campus
                        </a>
                    </li>
                    <li><a href="https://tinyurl.com/ynhp34k9" target="_blank" class="color-b">
                            <i class="fa-solid fa-location-pin"></i>CurePath - Prizren
                        </a>
                    </li>
                    <li>
                        <a href="https://tinyurl.com/3t3dxthx" target="_blank" class="color-b">
                            <i class="fa-solid fa-location-pin"></i>CurePath - Ferizaj
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="phone">
        ...
        <div class="locations-phone container-max center container-column">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2934.376467517507!2d21.146825!3d42.653377!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13549f3f9c98dcad%3A0x34f016cddf4a9928!2sDukagjini%20Center!5e0!3m2!1sen!2sus!4v1733760305573!5m2!1sen!2sus"
                style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" height="400px" width="90%">
            </iframe>
            <ul class="left">
                <h1 class="center color-bl" style="margin-bottom: 35px;">Our Locations:</h1>
                <li>
