...
<body>
    <div class="pc">
        ...
        <div class="aabout container-row bg-gray center">
            <a href="doctors.php">
                <h1 class="about-text animate__animated animate__fadeInDown h1-testt">Press here to look more onto our
                    doctors</h1>
            </a>
        </div>
    ...
    <div class="phone">
        ...
        <a href="doctors.php">
            <h1 class="about-text animate__animated animate__fadeInDown phoneservices center">Press here to look more
                onto our
                doctors</h1>
        </a>
        <div class="servicess container-row center bg-gray">
